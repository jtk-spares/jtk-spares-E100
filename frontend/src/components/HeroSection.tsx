  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(circle at 70% 20%, rgba(177,30,26,0.22) 0%, transparent 65%)',
        }}
      />
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-24">
        <div className="max-w-3xl">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 mb-8 px-3 py-1.5 border text-xs uppercase tracking-widest" style={{ borderColor: 'var(--card-border)', color: 'var(--color-text-muted)', backgroundColor: 'rgba(25,32,43,0.7)', fontFamily: 'var(--font-mono)' }}>
          ...
          <BlurText
            ...
            style={{ fontFamily: 'var(--font-display)', color: 'var(--color-text-primary)' } as React.CSSProperties}
          />

          <p className="text-lg max-w-xl leading-relaxed mb-10" style={{ color: 'var(--color-text-secondary)' }}>
          ...
          <div className="flex flex-wrap gap-4 mb-16">
            ...
            <a
              ...
              style={{ borderColor: 'var(--card-border)', color: 'var(--color-text-secondary)', backgroundColor: 'rgba(25,32,43,0.45)', minHeight: '44px', fontFamily: 'var(--font-mono)' }}
            >
              Our Services
            </a>
          </div>
          ...
          <div
            ...
            style={{ borderTop: '1px solid var(--card-border)', divideColor: 'var(--card-border)' } as React.CSSProperties}
          >
            {STATS.map(({ value, label }) => (
              <div key={label} className="flex flex-col px-6 pt-5 first:pl-0">
                ...
                <span className="text-xs uppercase tracking-widest mt-1" style={{ color: 'var(--color-text-muted)', fontFamily: 'var(--font-mono)' }}>
                  {label}
                </span>
              </div>
            ))}
